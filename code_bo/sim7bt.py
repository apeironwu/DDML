...
def main(argv): 
    ...
    K_fold = 3
    n = 500; p = 5; S = 10; n_rnd = 500; ver = 0; path_out = None
    # n = 500; p = 5; S = 10; n_rnd = 5; ver = 0; path_out = None; bl_log = False; bl_conv_step = False
    ...
    for seed_np in range(2025, 2025+n_rnd): 
        ...
        for s in range(S): 
            ...
            model_dml_cur, _, bl_conv_cur = dml.train_logistic_dml(ls_site[s], learning_rate, eps=1e-8)
